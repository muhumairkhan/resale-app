...
@section('content')
    ...
    <div class="jumbotron">
        <div class="container">
            <h1 class="display-3">Online Backyard Sale</h1>
            ...
            @if (count($posts)>0)
                @foreach($posts as $key => $post)
                    ...
                    <div class="col-md-5 col-md-offset-1" style="margin-top: 50px; border: 1px solid #ccc; border-radius: 5px; margin-left:50px;">
                        ...
                        <p></p>
                        <img class="img-fluid rounded" src="https://grittechnologies.com/wp-content/themes/grit-technologies/assets/img/blog/no-post-image.png" alt="">
                        <p></p>
